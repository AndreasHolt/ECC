...
Graph.prototype.getPointPlacement = function(x) {
    let point1 = document.getElementsByClassName('workingPoints')[0];
    let point2 = document.getElementsByClassName('workingPoints')[1]
    let x1 = (point1.getAttribute('cx')-this.centerX)/this.scaleX;
    let x2 = (point2.getAttribute('cx')-this.centerX)/this.scaleX;
    let returnValue;
...
function logicPointAddition(x) {
    ...
    let fromPoint = 0;
    if(pointDecider === 1) {
        let tempPoint = document.getElementsByClassName('workingPoints')
